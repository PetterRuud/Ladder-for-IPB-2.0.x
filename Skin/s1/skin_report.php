...
return <<<EOF
              ...
              <td class='row5'>{$row['rank']}&nbsp;<img src="{$ibforums->vars['img_url']}/gold.gif">&nbsp;&nbsp;<img src="{$ibforums->vars['img_url']}/blue5g.gif"></td>
                   <td class='row5'><a href='{$ibforums->base_url}showuser={$row['id']}'><b>{$row['name']}</b></a> [{$row['clanname']}]</td>
...
return <<<EOF
              ...
              <td class='row4'>{$row['rank']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="{$ibforums->vars['img_url']}/blue3g.gif"></td>
                 <td class='row4'><a href='{$ibforums->base_url}showuser={$row['id']}'><b>{$row['name']}</b></a> [{$row['clanname']}]</td>
...
return <<<EOF
              ...
              <td class='row6'>{$row['rank']}&nbsp;<img src="{$ibforums->vars['img_url']}/silver.gif">&nbsp;&nbsp;<img src="{$ibforums->vars['img_url']}/blue1g.gif"></td>
                 <td class='row6'><a href='{$ibforums->base_url}showuser={$row['id']}'><b>{$row['name']}</b></a> [{$row['clanname']}]</td>
...
<tr>
<td class='row2'><b>Your ID</b><td class='row2'>
{$ibforums->member['id']}
</tr>

<tr>
<td class='row2'><b>Your Name</b><td class='row2'>
{$ibforums->member['name']}
</tr>

<tr>
<td class='row2'><b>Status</b><td class='row2'>
<strong>WIN - ONLY REPORT THIS IF YOU HAVE GENUINLY WON.
IF YOUR UNSURE OPEN A TOPIC IN TC DISPUTES</strong>
</tr>
<tr>
 <td class='row2'><b>Your Clan</b><td class=pformright>{$r['clanname']}
...
return <<<EOF
<tr>
 <td class='row2'><b>Your Clan</b><td class='row2'>
 <select name=clan1>
...
return <<<EOF
<tr>
 <td class='row2'><b>Opponents Clan</b><td class='row2'>
 <select name=clan2>
 <option class=forminput value=''>Select A Clan</option>
 $data
 </select>
...
<tr>
<td class='row2'><b>Game Type</b>
<td class='row2'><select name=gamet><option class=forminput value=''>Select A Game Type<option class=forminput value='1'>1 vs 1<option class=forminput value='2'>2 vs 2<option class=forminput value='3'>3 vs 3</select></td>


<tr>
<td class='row2'><b>Map</b>
<td class='row2'><select name=gmmap><option class=forminput value=''>Select A Map
...
<table cellpadding='4' cellspacing='0' border='0' width='100%'>
<tr>
 <td class='row2'><b>Game Result</b></td>
 <td class=<'row2'>{$r['clanname']} defeats {$clan2_n}</td>
 </tr>
 <tr>
  <td class='row2'><b>Map Played</b></td>
  <td class='row2'>{$ibforums->input["gmmap"]}</td>
 </tr>
...
<table cellpadding='4' cellspacing='0' border='0' width='100%'>
<tr>
 <td class='row2'><b>Opponent #1</b></td>
 <td class='row2' colspan='2'>
 <select name=oppt1>
...
<table cellpadding='4' cellspacing='0' border='0' width='100%'>
<tr>
 <td class='row2'><b>Opponent #2</b></td>
 <td class='row2' colspan='2'>
 <select name=oppt2>
 <option class=forminput value=''>Select An Opponent</option>
 $data
...
<table cellpadding='4' cellspacing='0' border='0' width='100%'>
<tr>
 <td class='row2'><b>Opponent #3</b></td>
 <td class='row2' colspan='2'>
 <select name=oppt3>
 <option class=forminput value=''>Select An Opponent</option>
 $data
...
return <<<EOF
		...
		<td class='row2'><a href='{$ibforums->base_url}act=Usergroups&amp;code=det&amp;ugid={$data['ugid']}'>{$ibforums->lang['details']}</a></td>
